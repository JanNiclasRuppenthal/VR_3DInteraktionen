...
\includegraphics[width=0.9\textwidth, keepaspectratio]{img/NoWall-Frame}
}{vid/MovementAmesRoom.mp4}
...
\begin{figure}
    \centering
    \movie[externalviewer]{
\includegraphics[width=0.9\textwidth, keepaspectratio]{img/Wall-Frame}
}{vid/MovementAmesRoomWall.mp4}
...
\begin{figure}
    \centering
\includegraphics[width=0.75\textheight, keepaspectratio]{img/nick}
...
\begin{figure}
    \centering
\includegraphics[width=0.9\textwidth, keepaspectratio]{img/prototyp}
...
\begin{figure}
    \centering
    \movie[externalviewer]{
\includegraphics[height=0.8\textheight, keepaspectratio]{img/VR-Frame}
}{vid/VRMovementAmesRoom.mp4}
